...
from AppMiranda.views import producto, lista_productos, inicio, productos, clientes, empleados, producto_formulario, busqueda_codigo, buscar, cliente_formulario #empleado_formulario
